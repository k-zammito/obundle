...
export default class ImageGallery {
  ...
  setAlternateImage(imgObj) {
    imgObj.zoomImageUrl =
      this.$selectableImages[1].href.attr('data-zoom-image');
    if (!this.savedImage) {
      this.savedImage = {
        mainImageUrl: this.$mainImage.find('img').attr('src'),
        zoomImageUrl: this.$selectableImages[1].href.attr('data-zoom-image'),
  ...
  swapMainImage() {
    ...
    this.easyzoom
      ...
      .swap(
        ...
        this.$selectableImages[1].href,
        this.currentImage.mainImageSrcset
      );

    this.$mainImage.attr({
      'data-zoom-image': this.$selectableImages[1].href,
    });
